...
-- BEE HUB 🐝🍯 - ON/OFF buttons + animations + sounds + neon pulse glow
...
-- =========================================================
-- ✨ NEON PULSE GLOW (attached behind window)
-- =========================================================
...
-- Send glow visually behind window content
glow.ZIndex = -1
window.BackgroundColor3 = COLORS.windowBg

-- Infinite pulse tween
...
print("[BEE HUB 🐝🍯] Loaded with neon pulse glow.")