...
-- BEE HUB 🐝🍯 - ANTI-KICK always active + INSTANT STEAL EGG
...
-- =========================================================
-- 🛡️ ANTI-KICK (always active on load)
-- =========================================================
do
    if not getgenv().antikick then
        ...
        -- Bypass the game's kick synchronizer
        pcall(function()
        ...
        -- FireServer blocker for flagged kick calls
        local kck = "\239\187\191"
        local function isFlag(a)
            return type(a) == "string" and a:sub(-3) == kck
        end
        ...
        print("[BEE HUB] 🛡️ ANTI-KICK active.")
    else
        print("[BEE HUB] 🛡️ ANTI-KICK already running.")
    end
end
...
discord.Text = "🛡️ PROTECTED"
discord.TextColor3 = COLORS.green
